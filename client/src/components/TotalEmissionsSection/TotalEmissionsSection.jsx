/**
 * TotalEmissionsSection Bileşeni
 * =================================================================
 * greenculate'in karbon emisyonu için sebep olduğu toplam karbon
 * emisyonunun ve bu emisyonun günlük hayatta eşdeğerlerinin gösterildiği
 * bileşen.
 */
...
import "./TotalEmissionsSection.scss";

/**
 * @param {Object} show - Bileşenin gösterilip gösterilmeyeceğini belirtir
 */
const TotalEmissionsPage = ({ show }) => {
    ...
    const fetchEmissions = async () => {
      try {
        ...
        const pythonResponse = await axios.get(
          "http://localhost:5000/total-emission"
        );

        // Node backend'den http emisyonlarını al
        const nodeResponse = await axios.get(
          "http://localhost:3000/total-emission"
        );
  ...
  return (
    <AnimatedItem
      className="total-emissions-container"
      ...
      {error ? (
        ...
        <>
          ...
          <div className="info-note">
            ...
            <p>
              Bu değerler yaklaşık hesaplamalardır ve gerçek koşullara göre
